...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { action: @recommendation.action, note: @recommendation.note, price: @recommendation.price, symbol: @recommendation.symbol }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { action: @recommendation.action, note: @recommendation.note, price: @recommendation.price, symbol: @recommendation.symbol }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
